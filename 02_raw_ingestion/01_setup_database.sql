...
================================================================================
Purpose: Create database, schemas, warehouse, and foundational objects
...
SELECT 'Database setup completed successfully' AS status, CURRENT_TIMESTAMP() AS completed_at;
